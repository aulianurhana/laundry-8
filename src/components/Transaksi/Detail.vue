                          ...
                          <div class="row">
                            <div class="col">
                              ...
                              <div
                                class="h6 mb-0 font-weight-bold text-gray-800 mb-2"
                              >
                                {{ transaksi.tgl | moment("DD/MM/YYYY") }}
                              </div>
                              <div
                                class="text-xs font-weight-bold text-primary text-uppercase"
                              >
...
export default {
  ...
  created() {
    this.axios
      .get(
        `http://localhost/lat_laundry_8/public/api/tampiltransaksi/${this.id_transaksi}`,
    ...
    this.axios
      .get(
        `http://localhost/lat_laundry_8/public/api/transaksi/detail/${this.id_transaksi}`,
        { headers: { Authorization: `Bearer ` + this.$store.state.token } }
      )
      .then((res) => {
    ...
    this.axios
      .get(
        `http://localhost/lat_laundry_8/public/api/transaksi/total/${this.id_transaksi}`,
        { headers: { Authorization: `Bearer ` + this.$store.state.token } }
      )
      .then((res) => {
  ...
  methods: {
    ubahStatus() {
      ...
      this.axios
        .post(
          `http://localhost/lat_laundry_8/public/api/transaksi/status/${this.id_transaksi}`,
          this.transaksi,
          {
            headers: { Authorization: `Bearer ` + this.$store.state.token },
          }
    ...
    bayar() {
      this.axios
        .post(
          `http://localhost/lat_laundry_8/public/api/transaksi/bayar/${this.id_transaksi}`,
          this.transaksi,
          {
            headers: { Authorization: `Bearer ` + this.$store.state.token },
          }
